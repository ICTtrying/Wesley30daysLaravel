  ...
  <nav class="bg-gray-800/50">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          <div class="shrink-0">
            <img src="https://www.freeiconspng.com/thumbs/funny-icon/devil-icon-funny-icon-5.png" alt="angry" class="size-8" />
          </div>
          ...
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <el-dropdown class="relative ml-3">
              <button class="relative flex max-w-xs items-center rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
                ...
                <img src="https://cms.dierenbescherming.nl/assets/common/default/Dieren/Katten/Boze-kat-istock-2_2024-03-21-104904_ppoo.jpg" alt="" class="size-8 rounded-full outline -outline-offset-1 outline-white/10" />
              </button>
    ...
    <el-disclosure id="mobile-menu" hidden class="block md:hidden">
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        ...
        <a href="/testpage" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">testpage</a>

      </div>
      <div class="border-t border-white/10 pt-4 pb-3">
        <div class="flex items-center px-5">
          <div class="shrink-0">
            <img src="https://cms.dierenbescherming.nl/assets/common/default/Dieren/Katten/Boze-kat-istock-2_2024-03-21-104904_ppoo.jpg" alt="" class="size-10 rounded-full outline -outline-offset-1 outline-white/10" />
          </div>
          <div class="ml-3">
            <div class="text-base/5 font-medium text-white">Wil bierman</div>
            <div class="text-sm font-medium text-gray-400">wilBierman@example.com</div>
          </div>
