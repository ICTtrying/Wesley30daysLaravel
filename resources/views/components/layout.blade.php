            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        <div class="shrink-0">
                            <img src="https://www.freeiconspng.com/thumbs/funny-icon/devil-icon-funny-icon-5.png"
                                alt="angry" class="size-8" />
                        </div>
                        ...
                        <div class="ml-4 flex items-center md:ml-6">
                            ...
                            <el-dropdown class="relative ml-3">
                                <button
                                    ...
                                    <img src="https://cms.dierenbescherming.nl/assets/common/default/Dieren/Katten/Boze-kat-istock-2_2024-03-21-104904_ppoo.jpg"
                                        alt=""
